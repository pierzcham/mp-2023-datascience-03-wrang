---
title: "HW - Road traffic accidents"
output: 
  tufte::tufte_html:
    css: ../hw.css
...
The data are made available by the UK Government.
...
Knit the R Markdown document `hw.Rmd `to md (github_document). Make sure it compiles without errors.
...
You can also find this information [here](https://tidyverse.github.io/dsbox/reference/accidents.html).
